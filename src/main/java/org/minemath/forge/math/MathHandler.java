package org.minemath.forge.math;
...
import org.minemath.forge.screen.HistoryScreen;
...
import static org.minemath.forge.screen.HistoryScreen.MathList;
...
public class MathHandler {
    ...
    public void buttonHandler(int buttonId) {
        switch (buttonId){
            case 0:
                Minecraft.getInstance().setScreen(new HistoryScreen(Component.empty(), MathList));
                break;
            case 3:
